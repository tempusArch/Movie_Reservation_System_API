...
using MovieReservationSystemAPI.Controller;
...
builder.Services.AddDbContext<MovieReservationSystemApiDbContext>(options => 
...
builder.Services.AddHostedService<ReservationStatusCompleteBackgroudJob>();
